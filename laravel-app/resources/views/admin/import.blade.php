    ...
    <section class="space-y-6" x-data="planImport()">
        ...
        <div class="grid gap-6 lg:grid-cols-[2fr,1fr]">
            <form
                ...
                hx-post="{{ route('admin.import.store') }}"
                ...
                <div class="space-y-2">
                    ...
                    >
                        ...
                        @foreach ($users as $user)
                            <option value="{{ $user->getKey() }}">{{ $user->display_name }}</option>
                        @endforeach
                    </select>
                    @if ($users->isEmpty())
            ...
            <aside class="space-y-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                ...
                <ul class="space-y-2 text-sm text-slate-600">
                    ...
                    <li>After importing, review progress from the board or plan view—sections refresh without reloading.</li>
                </ul>
                <div
